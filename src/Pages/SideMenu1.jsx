                                ...
                                >
                                    <GridColumnGroup>
                                        <GridHeaderRow>
                                            ...
                                            >№</GridColumn>
                                            <GridColumn rowspan={2} width={300} field="businesName" title="Ташкилот номи" ></GridColumn>
                                            <GridColumn rowspan={2} width={200} field="dateOfApplication" title="Мурожаат этилган сана" ></GridColumn>
                                            ...
                                            <GridColumn rowspan={2} width={100} field="gender" title="Жинси" ></GridColumn>
                                            <GridColumn rowspan={2} width={200} field="passportNumber" title="Паспорт серияси ва рақами" ></GridColumn>
                                            ...
                                            <GridColumn rowspan={2} width={200} field="registerDate" title="Рўйхатдан ўтилган сана" ></GridColumn>
                                            <GridColumn rowspan={2} width={200} field="direction" title="Йўналиши" ></GridColumn>
                                            <GridColumn rowspan={2} width={100} field="payType" title="Тўлов тури" ></GridColumn>
                                            <GridColumn colspan={4} width={200} field="" title="Тақдим этилган" ></GridColumn>
                                            <GridColumn rowspan={2} width={300} field="serviceResult" title="Хизмат натижаси" align="center" ></GridColumn>
                                            <GridColumn rowspan={2} width={200} field="execution" title="Ижрочи" ></GridColumn>
                                        </GridHeaderRow>
                                        <GridHeaderRow>
                                            <GridColumn width={200} field="document" title="Хужжат" ></GridColumn>
                                            <GridColumn width={200} field="docSeria" title="Серия рақами" ></GridColumn>
                                            <GridColumn width={200} field="image" title="Электрон расм" ></GridColumn>
