...
class SideMenu4 extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            pagination: {
    ...
    componentDidMount() {
        axios.get("http://localhost:9000/api/auth/abmks").then(res => {
            this.setState({
                data_table: res.data,
                isData: true
            })
                ...
                <div>
                    <Box mt={2} mb={1} >
                        <Card className={styles.data_top_card}>
                            <NavLink to="/createabkm" style={{ textDecoration: 'none' }}>
                                <Button
                                    variant="contained"
                                    color="primary"
                                ...
                                >
                                    <GridColumnGroup>
                                        <GridHeaderRow>
                                            ...
                                            <GridColumn colspan={4} width={200} field="" title="АБКМ йўлланма" ></GridColumn>
                                            <GridColumn rowspan={2} width={200} field="regDate" title="Рўйхатдан ўтилган сана" ></GridColumn>
                                            <GridColumn rowspan={2} width={200} field="branch" title="Исполнитель" ></GridColumn>
                                            <GridColumn colspan={5} width={200} field="" title="Тақдим этилган" ></GridColumn>
                                            <GridColumn rowspan={2} width={300} field="serviceResult" title="Хизмат натижаси" align="center" ></GridColumn>
                                            <GridColumn rowspan={2} width={200} field="performer" title="Филиал" ></GridColumn>
                                        </GridHeaderRow>
                                        <GridHeaderRow>
                                            <GridColumn width={200} field="rRegion" title="вилоят" ></GridColumn>
                                            <GridColumn width={200} field="rDistrict" title="туман" ></GridColumn>
                                            <GridColumn width={200} field="rSeriaNumber" title="серия рақами" ></GridColumn>
                                            <GridColumn width={200} field="rDate" title="санаси" ></GridColumn>
                                            <GridColumn width={200} field="seriaAndNumber" title="хужжат" ></GridColumn>
                                            <GridColumn width={200} field="document" title="серия рақами" ></GridColumn>
                                            <GridColumn width={200} field="electronPhoto" title="эл.расм" ></GridColumn>
                                            <GridColumn width={200} field="date" title="дата" ></GridColumn>
                                            <GridColumn width={200} field="executeDate" title="санаси" ></GridColumn>
                                        </GridHeaderRow>
                                    </GridColumnGroup>
                                </DataGrid>
                            </Card>
