...
class CreateDataPage extends React.Component {
  ...
  onHandleSubmit() {
    ...
    delete data.checked;
    axios
      .post("http://localhost:9000/api/auth/createPhisical", data)
      .then((res) => {
        if (res.data === "success") {
          this.setState({
            isRedirect: true,
                ...
                <Grid item xs={12} className={styles.createDataTop}>
                  <NavLink to="/" style={{ textDecoration: "none" }}>
                    <Button
                      ...
                      onClick={() => sessionStorage.setItem("pathname", "/")}
                    >
                      Back
                    </Button>
                  </NavLink>
                  <div
                    className={styles.createDataTopName}
                    style={{
            ...
            >
                ...
                <Grid container spacing={3}>
                  <Grid item xs={3}>
                    <FormControl fullWidth className={classes.margin}>
                      <InputLabel htmlFor="passwordNumber">
                        passportNumber
                      </InputLabel>
                      <Input
                        id="passwordNumber"
              ...
              <Box mt={3}>
                ...
                <Grid container direction="row" spacing={3}>
                  ...
                  <Grid item xs={3}>
                    <FormControl fullWidth className={classes.margin}>
                      <InputLabel htmlFor="serviceResult">
                        serviceResult
                      </InputLabel>
                      <Input
                        id="serviceResult"
