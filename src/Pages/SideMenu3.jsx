...
class SideMenu3 extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            pagination: {
    ...
    componentDidMount() {
        axios.get("http://localhost:9000/api/auth/tadbirkorliks").then(res => {
            this.setState({
                data_table: res.data,
                isData: true
            })
                ...
                <div >
                    <Box mt={2} mb={1} >
                        <Card className={styles.data_top_card}>
                            <NavLink to="/createbusinessman" style={{ textDecoration: 'none' }}>
                                <Button
                                    variant="contained"
                                    color="primary"
                                ...
                                >
                                    <GridColumnGroup>
                                        <GridHeaderRow>
                                            ...
                                            <GridColumn rowspan={2} width={200} field="performer" title="Ижрочи" ></GridColumn>
                                        </GridHeaderRow>
                                        <GridHeaderRow>
