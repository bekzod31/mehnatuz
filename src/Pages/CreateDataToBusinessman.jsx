...
class CreateDataToBusinessman extends React.Component {
    constructor(props) {
        super(props)
        this.state = {
            adress: '',
                        ...
                        <Box>
                            <Grid container spacing={1}>
                                <Grid item xs={12} className={styles.createDataTop}>
                                    <NavLink to="/menuthree" style={{ textDecoration: 'none' }}>
                                        <Button
                                            variant="contained"
                                            color="primary"
...
export default withStyles(useStyles)(CreateDataToBusinessman);