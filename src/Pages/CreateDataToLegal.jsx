...
class CreateDataToLegal extends React.Component {
    constructor(props) {
        super(props)
        this.state = {
            appliedDate: '',
    ...
    onHandleSubmit() {
        ...
        delete data.checked;
        axios.post('http://localhost:9000/api/auth/createJismoniy', data).then(res => {
            console.log(res)
            if (res.data === 'success') {
                this.setState({
                    isRedirect: true
                        ...
                        <Box>
                            <Grid container spacing={1}>
                                <Grid item xs={12} className={styles.createDataTop}>
                                    <NavLink to="/menuone" style={{ textDecoration: 'none' }}>
                                        <Button
                                            variant="contained"
                                            color="primary"
                            ...
                            <Box mt={2}>
                                ...
                                <Grid container spacing={3}>
                                    ...
                                    <Grid item xs={3}>
                                        ...
                                        <FormControl fullWidth className={classes.margin}>
                                            <InputLabel htmlFor="standard-adornment-amount">electronicPic</InputLabel>
                                            <Input
                                                id="standard-adornment-amount"
                                                name="electronicPic"
...
export default withStyles(useStyles)(CreateDataToLegal);